...
arrow_shotSound = pg.mixer.Sound( path + '238159__jtragaudio__fuzzsound-bullet.wav')
enemy_hitSound = pg.mixer.Sound( path + 'zombiehit.wav')
player_hitSound = pg.mixer.Sound(path +'350984__cabled-mess__lose-c-03.wav')
...
class Player(pg.sprite.Sprite):
    ...
    def update(self):
        ...
        #can't move off the sides of the screen
        ...
        for arrow in arrows:
            for zombie in zombies:
                if arrow.rect.colliderect(zombie.rect):
                    enemy_hitSound.play() #plays the sound effect of the enemy getting hit
                    self.score+=1
                    if zombie.health > 10:
                        zombie.health -= 10
                    else:
